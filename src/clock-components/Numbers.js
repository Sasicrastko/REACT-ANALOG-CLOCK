            ...
            <div className="hour-scale">
                ...
                return(
                    <div 
                        key={H} 
                        className="diameter" 
                        style={{transform : `rotate(${H*360/12-90}deg)`, position: `absolute`, top: `45%`, left: `0%`, width: `100%`, height: `10%`}}
                    >
                        <div 
                            className="N" 
                            style={{transform: rotationAngleForNumberField, position: `absolute`, backgroundColor: `transparent`, top: `0%`, left: `90%`, width: `10%`,  height: `100%`}}
                        >
                            <div 
                                className="number" 
                                style={{fontSize: `${this.props.numberSize}%`, color: this.props.color}}
                            >
                                {numerals[H-1]}
                            </div>
                        </div>
